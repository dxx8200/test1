		...
		<ConfigRoot>
			<CANConfigs>
				<xsl:for-each select="ConfigRoot/IOTranConfig/CANConfigs/CANConfig">
					<CANConfig>
						...
						<xsl:if test="$model/LinkedModel/Links/Link[Type='CAN']/Variables/Variable/Protocol[ChannelId=current()/@IOPort]">
              ...
              <xsl:attribute name="VarName">
                <xsl:value-of select="$model/LinkedModel/Links/Link[Type='CAN']/Variables/Variable[Protocol/ChannelId=current()/@IOPort]/Name"/>
              </xsl:attribute>
			...
			<SerialConfigs>
				<xsl:for-each select="ConfigRoot/IOTranConfig/SerialConfigs/SerialConfig">
					<SerialConfig>
						<xsl:copy-of select="current()/@*"/>
						<xsl:if test="$model/LinkedModel/Links/Link[Type='RS422' or Type='RS232' or Type='RS485']/Variables/Variable/Protocol[ChannelId=current()/@IOPort]">
              ...
              <xsl:attribute name="VarName">
                <xsl:value-of select="$model/LinkedModel/Links/Link[Type='RS422' or Type='RS232' or Type='RS485']/Variables/Variable[Protocol/ChannelId=current()/@IOPort]/Name"/>
              </xsl:attribute>
              <xsl:attribute name="BaudRate">
			...
			<EtherConfigs>
				<xsl:for-each select="ConfigRoot/IOTranConfig/EtherConfigs/EtherConfig">
					<EtherConfig>
						<xsl:copy-of select="current()/@*"/>
						<xsl:if test="$model/LinkedModel/Links/Link[Type='Ethernet']/Variables/Variable/Protocol[ChannelId=current()/@IOPort]">
              ...
              <xsl:attribute name="VarName">
                <xsl:value-of select="$model/LinkedModel/Links/Link[Type='Ethernet']/Variables/Variable[Protocol/ChannelId=current()/@IOPort]/Name"/>
              </xsl:attribute>
              <xsl:attribute name="SimIP">
                <xsl:value-of select="$cofether/LocalIP"/>
              </xsl:attribute>
              <xsl:attribute name="SimMask">
                <xsl:value-of select="$cofether/LocalMask"/>
              </xsl:attribute>
              <xsl:attribute name="SimPort">
                <xsl:value-of select="$cofether/LocalPort"/>
              </xsl:attribute>
            </xsl:if>
					</EtherConfig>
				</xsl:for-each>
